...
namespaces = {'eInvoiceNameSpace': 'https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/tiqueteElectronico'}
alphabetRegex = "^[a-zA-Z]+$"
totalNodesNamesTE = ["TotalServGravados", "TotalServExentos", "TotalServExonerado", "TotalMercanciasGravadas",
...
def validateTotalsInfo(data: xml.etree.ElementTree.Element):
    ...
    results = validateTotals(einviceSummaryNode, totalNodesNamesTE, data)
