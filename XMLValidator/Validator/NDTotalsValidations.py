...
namespaces = {'eInvoiceNameSpace': 'https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaDebitoElectronica'}
alphabetRegex = "^[a-zA-Z]+$"
totalNodesNamesND = ["TotalServGravados", "TotalServExentos", "TotalServExonerado", "TotalMercanciasGravadas",
...
def validateTotalsInfo(data: xml.etree.ElementTree.Element):
    ...
    results = validateTotals(einviceSummaryNode, totalNodesNamesND, data)
