...
totalNodesNamesFEC = ["TotalServGravados", "TotalServExentos", "TotalServExonerado", "TotalMercanciasGravadas",
                   "TotalMercanciasExentas", "TotalMercExonerada", "TotalGravado", "TotalExento", "TotalExonerado",
                   "TotalVenta", "TotalDescuentos", "TotalVentaNeta", "TotalImpuesto",
...
def validateTotalsInfo(data: xml.etree.ElementTree.Element):
    ...
    results = validateTotals(einviceSummaryNode, totalNodesNamesFEC, data)
