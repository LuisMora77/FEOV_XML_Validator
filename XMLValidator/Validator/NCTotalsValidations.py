...
namespaces = {'eInvoiceNameSpace': 'https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/notaCreditoElectronica'}
alphabetRegex = "^[a-zA-Z]+$"
totalNodesNamesNC = ["TotalServGravados", "TotalServExentos", "TotalServExonerado", "TotalMercanciasGravadas",
...
def validateTotalsInfo(data: xml.etree.ElementTree.Element):
    ...
    results = validateTotals(einviceSummaryNode, totalNodesNamesNC, data)
