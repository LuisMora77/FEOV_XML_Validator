...
def run(path, xmlType,docType):
    result = XMLValidator.validateXML(path, xmlType,docType)
...
def runPath(xml, typeEinvoice, docType):
    return run(xml, typeEinvoice,docType)